const Contract = artifacts.require("TakyonDocuments");
...
contract("test", async (accounts) => {
  ...
  it("should mint", async () => {
    ...
    assert.equal(Number(newSupply), Number(initialSupply) + 1);
  });

  it("should mint again", async () => {
    const initialSupply = await contract["totalSupply"]();
